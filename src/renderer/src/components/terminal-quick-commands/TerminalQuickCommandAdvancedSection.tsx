...
import { TerminalQuickCommandRunInActiveTabSwitch } from './TerminalQuickCommandRunInActiveTabSwitch'
        ...
        <div className="min-h-0">
          ...
          >
            {!isTerminalAgentQuickCommand(draft) ? (
              <>
                <TerminalQuickCommandRunInActiveTabSwitch
                  runInActiveTab={draft.runInActiveTab === true}
                  onToggle={toggleRunInActiveTab}
                />
